...
{
    public static class ZatcaCustomField
    {
        public const string CertificateInfoGuid = "12345678-1234-5678-9abc-def000000001";
        public const string ApprovedInvoiceGuid = "12345678-1234-5678-9abc-def000000002";
        public const string InvoiceSubTypeGuid = "12345678-1234-5678-9abc-def000000003";
        public const string ItemTaxCategoryGuid = "12345678-1234-5678-9abc-def000000004";
        public const string PaymentMeansCodeGuid = "12345678-1234-5678-9abc-def000000005";
        public const string InstructionNoteGuid = "12345678-1234-5678-9abc-def000000006";
        public const string PartyTaxInfoGuid = "12345678-1234-5678-9abc-def000000007";
        public const string QrCodeGuid = "12345678-1234-5678-9abc-def000000008";
        public const string IcvPihGuid = "12345678-1234-5678-9abc-def000000009";
    }
    ...
    public class CertificateInfo
    {
        ...
        public string ApiEndpoint { get; set; } = "http://127.0.0.1:55667/api2";
