...
public class Program
{
    public static void Main()
    {
        ...
        //    string xresultString = xresult?.ToString();

        //    if (!string.IsNullOrEmpty(xresultString))
        //    {
        //        xresultString = xresultString.Replace("Customer", "InvoiceParty")
        ...
        //        Console.WriteLine(xresultString);
        //    }
        //    else
        //    {
        //        Console.WriteLine($"Key '{key}' not found in the JSON structure.");
        //    }
        ...
        ApprovedInvoice invoice = new ApprovedInvoice
        {
            ZatcaUUID = "UUID-123",
            ManagerUUID = "MGR-456",
        ...
        string base64Invoice = ObjectCompressor.SerializeToBase64String(invoice);
        Console.WriteLine("Serialized Base64 Invoice: " + base64Invoice);

        // Deserialize from Base64 string
        ApprovedInvoice deserializedInvoice = ObjectCompressor.DeserializeFromBase64String<ApprovedInvoice>(base64Invoice);
        Console.WriteLine("Deserialized Invoice UUID: " + deserializedInvoice.ZatcaUUID);
    }
...
//        // Deserialize the JSON string to an object using Newtonsoft.Json
